...
class FlySpatialParameters():
	def __init__(self, config):
		...
		self.dt = None #Time step. None makes sure this is assigned only in gym env reset.  
		self.walk_step_size = None #Distance traveled in one time step. None makes sure this is assigned only in gym env reset.
		self.ang_step_size = None ## Angle turned in one time step. None makes sure this is assigned only in gym env reset. 
