...
from src.models.odor_senses_2D import OdorFeatures, CONCENTRATION_THRESHOLD
...
class PlumeMotionNavigationEnvironment(Env):
    ...
    Actual instances of this class are composed in motion_environment_factory_2D.py
    ...
    def __init__(self,
        ...
        self.action_space = Discrete(9)  # This should go in the factory?
    ...
    def step(self, action: ActType):
        ...
        self.odor_features.update(sensor_location=self.fly_spatial_parameters.position,
                                  odor_plume_frame=self.odor_plume.frame,
                                  prior_odor_plume_frame=self.prior_frame)
        #Note to self: somehow the 14-expansion happens here
        reward = self.reward
